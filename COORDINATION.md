...
|---|---|---|---|---|---|
| Codex | `codex/sam3-box-guided-bakeoff` | #195 | Diagnostics/data-only MLX SAM3 box-guided face prompt bakeoff; preserves negative vertex result for 7-anchor geometry boxes. | `tools/SAM3_MLX_BOX_GUIDED_PROMPT_BAKEOFF_V0_REPORT.md`, `tests/fixtures/sam3_mlx_box_guided_prompt_bakeoff_v0_easy_summary.json`, `tests/test_sam3_mlx_box_guided_prompt_bakeoff_v0.py` | ready for audit |
