...
records candidate counts, failed checks, repair timings, and the top repair candidates. Use it on a
small `--set-id` selection rather than the whole hard-case manifest unless you really want to wait.
