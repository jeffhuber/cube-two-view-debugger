...
from tools.patch_junction_vertex_localizer_v0 import (
    DEFAULT_SUMMARY,
    PatchJunctionVertexConfig,
    generate_patch_junction_vertex_localizer_summary,
    render_report,
)


def test_patch_junction_vertex_localizer_handles_synthetic_feedback(tmp_path: Path):
    rows = []
    ...
    assert document["rows"][0]["featureCount"] > 30
    assert document["summary"]["patchJunctionTop1PlausibleCount"] >= 1


def test_patch_junction_render_report_includes_no_wire_language():
    report = render_report(
        {
            "summary": {
                ...
                "patchJunctionTop1StrictCount": 1,
                "patchJunctionTop1PlausibleCount": 1,
                "patchJunctionGatedStrictCount": 1,
                "patchJunctionGatedPlausibleCount": 1,
                "axisGoodBaselineStrictCount": 0,
                "axisGoodPatchJunctionGatedStrictCount": 1,
                "patchJunctionGatedAcceptedCount": 1,
                "patchJunctionTop1ImprovedRowCount": 1,
                "patchJunctionTop1WorsenedRowCount": 1,
                "patchJunctionGatedImprovedRowCount": 1,
                "patchJunctionGatedWorsenedRowCount": 1,
                "meanBaselineVertexErrorPx": 100.0,
                "meanCandidateOracleVertexErrorPx": 5.0,
                "meanPatchJunctionTop1VertexErrorPx": 40.0,
                "meanPatchJunctionGatedVertexErrorPx": 40.0,
                "medianBaselineVertexErrorPx": 100.0,
                "medianCandidateOracleVertexErrorPx": 5.0,
                "medianPatchJunctionTop1VertexErrorPx": 40.0,
                "medianPatchJunctionGatedVertexErrorPx": 40.0,
                "patchJunctionThresholdSweep": {
    ...
    assert "Feature Families" in report


def test_committed_patch_junction_vertex_localizer_summary_is_strict_json():
    ...
    assert parsed["probe"] == "patch_junction_vertex_localizer_v0"
