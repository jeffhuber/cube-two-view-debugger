...
> **Legacy-data caution (2026-05-23):** this report is derived from the
> axis-labeled gallery and legacy `near_*` semantics. Treat row-level
> phase/chirality categories as provisional until regenerated from
