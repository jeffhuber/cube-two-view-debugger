...
- `needs_manual_review`: a state was returned, but the path was ambiguous, lower confidence,
  relied on heavier repair, or hit a conservative grid-purity manual-review guard.
